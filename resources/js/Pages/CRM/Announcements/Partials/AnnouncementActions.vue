...
import AnnouncementActionHistory from "@/Pages/CRM/Announcements/Partials/AnnouncementActionHistory.vue";
...
const items = ref([
    {
        label: 'announcement_action_history',
        icon: h(IconIdBadge2),
        command: () => {
            visible.value = true;
            dialogType.value = 'announcement_action_history';
            title.value = 'announcement_action_history';
        },
    },
    {
...
const requireConfirmation = (action_type) => {
    const messages = {
        delete_announcement: {
            ...
            message: trans('public.delete_announcement_desc'),
...
<template>
    ...
    >
        <template v-if="dialogType === 'announcement_action_history'">
            <AnnouncementActionHistory
