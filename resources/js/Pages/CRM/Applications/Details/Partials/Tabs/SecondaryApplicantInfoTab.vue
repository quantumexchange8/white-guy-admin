...
<template>
    <div class="flex flex-col justify-center items-center gap-2 self-stretch">
        <div class="flex justify-between items-start self-stretch">
            <span class="w-full text-gray-950 dark:text-gray-100 font-bold text-xxl break-words">{{ $t('public.secondary_applicant_info') }}</span>
            <Button
                type="button"
                iconOnly
                size="base"
        ...
        <div v-else class="w-full grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-5">
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.title') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_title ? props.application?.sec_title : '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.name') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_full_name || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.email') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_email || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.address') }}</div>
                <div class="text-gray-700 dark:text-gray-300 font-medium break-all">{{ props.application?.sec_address || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.date_of_birth') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_date_of_birth || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.place_of_birth') }}</div>
                <div class="text-gray-700 dark:text-gray-300 font-medium break-all">{{ props.application?.sec_place_of_birth || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.marital_status') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_marital_status || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.nationality') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_nationality || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.country') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_country || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.passport_number') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_passport_number || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.mobile_phone_number') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_mobile_phone_number || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.home_phone_number') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_home_phone_number || '-' }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div class="text-gray-500 dark:text-gray-100 truncate">{{ $t('public.business_phone_number') }}</div>
                <div class="truncate text-gray-700 dark:text-gray-300 font-medium">{{ props.application?.sec_business_phone_number || '-' }}</div>
            </div>
        </div>
    </div>
