...
class PrivateMessageController extends Controller
{
    ...
    {
        return Inertia::render('CRM/PrivateMessages/PrivateMessageListing');
    }
    ...
    public function getPrivateMessageLogEntries(Request $request)
    {
        $contentTypeId = ContentType::with('auditLogEntries')
                                        ->where('app_label', 'core')
                                        ->where('model', 'privatemessage')
                                        ->select('id')
                                        ->get();
